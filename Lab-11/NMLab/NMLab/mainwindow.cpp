...
Оно посвящено численному решению задачи Коши для конкретной системы ОДУ 2-го порядка.\n\n\
...
// Численное решение
    ...
    auto solution = ivp_step_adjust(rk4_system2, Diff_equation<Point<2>,2>{f1,f2}, x0, Point<2>{u0,u0_dash/L}, h, x_max, x_eps, v_eps, n_max);
